    ...
    return (
        <div className={sticky? "container sticky":"container"}>
            <div className='menu-icon' id="burgir">
                <svg xmlns="http://www.w3.org/2000/svg"  style={{color:"red",width:"30px",height:"30px"}} width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16" onClick={()=>setState(!state)}>
